# PROGRAMME PCF VILLEFRANCHE-DE-ROUERGUE 2026
## Document complet - Toutes les mesures

---

## INTRODUCTION

### Et si on changeait vraiment les choses à Villefranche ?
...
**Document présenté par Patrick Cabandé, responsable des communistes villefranchois**

---

### Le titre de la mesure

**Exemple : Grenoble, Paris**
...
### Zéro blabla", detail: "Tout est chiffré, vérifié et réalisable dès 2026

### Tu peux participer", detail: "On t'accompagne si tu veux défendre ce programme ou rejoindre une liste


## Bloc 1 — Pouvoir citoyen et République locale
...
### Assemblées citoyennes dotées d'un droit de veto
...
**Exemple : Saillans (Drôme, 1 200 habitant·es)**
...
### Budget participatif porté à 5 % des investissements
...
**Exemple : Grenoble (Isère, 160 000 habitant·es)**
...
### Charte éthique et révocation citoyenne
...
**Exemple : Kingersheim (Haut-Rhin, 13 000 habitant·es)**
...
**Exemple : Paris (Île-de-France, 2,2 millions d'habitant·es)**
...
### Conseil citoyen permanent du budget
...
**Exemple : Grigny (Rhône, 9 000 habitant·es)**
...
### Mairies de quartier accessibles 7j/7
...
**Exemple : Malakoff (Hauts-de-Seine, 31 000 habitant·es)**
...
## Bloc 2 — Services publics et solidarités
...
### Crèches et centres de loisirs GRATUITS en régie municipale
...
**Exemple : Montpellier, Vierzon, Paris**
...
### Eau en régie publique avec tarification sociale
...
**Exemple : Grenoble, Paris, communes en régie**
...
### Maison du Peuple Bastide : réouvrir la CPAM et regrouper les services publics
...
**Exemple : Roubaix (Nord, 99 000 habitant·es)**
...
**Exemple : Aubervilliers (Seine-Saint-Denis, 88 000 habitant·es)**
...
**Exemple : Bègles (Gironde, 28 000 habitant·es)**
...
### Cantines locales et sociales : 80 % de produits aveyronnais
...
**Exemple : Mouans-Sartoux (Alpes-Maritimes, 10 000 habitant·es)**
...
### Accès au numérique pour toutes et tous
...
**Exemple : Lille (Nord, 236 000 habitant·es)**
...
### Résidence autonomie et maintien à domicile
...
**Exemple : Montreuil (Seine-Saint-Denis, 111 000 habitant·es)**
...
### Aire de grand passage pour les gens du voyage : respecter la loi, combattre le racisme
...
**Exemple : Nantes Métropole, Rennes Métropole**
...
**Exemple : Saint-Denis (Seine-Saint-Denis, 113 000 habitant·es)**
...
### Plan propreté et embellissement : brigade municipale d'entretien
...
**Exemple : Rennes Métropole (Bretagne, 220 000 habitants)**
...
## Bloc 3 — Transition écologique populaire
...
### Plan arbres et fraîcheur : 3000 arbres + bassin de baignade + Place Fontanges écologique
...
**Exemple : Clermont-Ferrand (Puy-de-Dôme, 147 000 habitant·es)**
...
### Révolution solaire et énergie citoyenne
...
**Exemple : Loos-en-Gohelle (Pas-de-Calais, 6 600 habitant·es)**
...
### Basti'Bus pérennisé avec fréquence doublée et horaires adaptés
...
**Exemple : Grenoble, Dunkerque, Bonneuil-sur-Marne**
...
**Exemple : Besançon (Doubs, 119 000 habitant·es)**
...
**Exemple : Ungersheim (Haut-Rhin, 2 200 habitant·es)**
...
## Bloc 4 — Travail, économie locale et culture
...
### Soutien massif aux commerces et artisans de la Bastide
...
**Exemple : Lyon (Rhône, 523 000 habitant·es)**
...
### Régie municipale du bâtiment : 50 emplois créés
...
**Exemple : Grenoble - Quartier Villeneuve (Isère)**
...
### Pass Culture-Sport gratuit pour tous les jeunes
...
**Exemple : Bologne (Italie, 391 000 habitant·es)**
...
### Pôle culturel et associatif au Château de Graves
...
**Exemple : Nantes (Loire-Atlantique, 320 000 habitant·es)**
...
**Exemple : Vaulx-en-Velin (Rhône, 51 000 habitant·es)**
...
## Bloc 5 — Jeunesse, éducation et quartiers populaires
...
### Plan écoles 100 % rénovées d'ici 2030
...
**Exemple : Poitiers (Vienne, 91 000 habitant·es)**
...
### Crèches publiques gratuites et horaires élargis
...
**Exemple : Vitry-sur-Seine (Val-de-Marne, 94 000 habitant·es)**
...
### Conseil municipal des jeunes avec VRAI pouvoir
...
**Exemple : Rennes (Ille-et-Vilaine, 222 000 habitant·es)**
...
### Accompagnement scolaire GRATUIT pour toutes et tous
...
### Activités périscolaires gratuites et de qualité
...
**Exemple : Bobigny (Seine-Saint-Denis, 55 000 habitant·es)**
...
### Cantines scolaires GRATUITES pour tous les enfants
...
### Petits déjeuners gratuits dans TOUTES les écoles
...
**Exemple : Grigny (Essonne, 29 000 habitant·es)**
...
### Fournitures scolaires GRATUITES : rentrée gratuite pour tous
...
### D'où viennent les données sur Villefranche ?

### Comment on a choisi ces mesures ?

### C'est chiffré comment ?

### Comment je peux vérifier ?

### Et si je veux proposer autre chose ?

### Les chiffres clés de Villefranche

### Pourquoi un maire communiste militant ?
